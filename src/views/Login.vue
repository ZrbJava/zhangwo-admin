<template>
    <div class="login">
        <form class="loginBox" action="test.php" autocomplete="on">
            <img src="../assets/logo.png" alt="" class="logoImg">
            <input type="text" class="inp bg" placeholder="商家账号" autofocus="autofocus" v-model="userName">
            <input type="password" class="inp bg" placeholder="密码" v-model="passWord">
            <div class="flex">
                <input type="number" placeholder="验证码" class="verificationInp bg">
            ...
            <button class="loginBtn inp" @click="login">登陆</button>
            <!-- <input type="submit" > -->
            <!-- <button type="submit">denglu</button> -->
            <div class="dec">如果密码忘记了，请联系掌窝工作人员</div>
        </form>
    </div>
</template>
...
<style scoped lang="less">
    ...
    .login{
        ...
        height:100vh;
        overflow:hidden;
        background:url("../assets/bigBG.png")no-repeat center;
